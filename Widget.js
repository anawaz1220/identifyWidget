    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], { /*jshint unused: false*/
      ...
      _initResultFormatString: function () {
        ...
        if(this.config.resultFormat){
          ...
          oLine = this.config.resultFormat.attValuesymbol.outline;
          ...
          if (oLine) {
            attribValue = "<div style='border: 1px solid #000; padding: 10px;'>" + attribValue + "</div>";
          }
          if(vColorHex){
      ...
      _initTabContainer: function () {
        ...
        // Set the default selected tab to 'resultslabel'
        this.selTab = this.nls.resultslabel;
